...
public:
	...
	std::pair<double, std::vector<std::vector<double>>> forward_scaled(const std::vector<int> &o) const;
...
private:
	...
	std::pair<double, std::vector<int>> viterbi_logged(const std::vector<int> &o) const;

	/// Calculates beta values.
	std::vector<std::vector<double>> backward(const std::vector<int> &o) const;
	std::vector<std::vector<double>> backward_scaled(const std::vector<int> &o) const;
