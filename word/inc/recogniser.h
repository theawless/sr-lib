...
private:
	...
	/// Constructor.
	Recogniser(std::vector<std::string> words, std::vector<std::vector<std::string>> sentences, std::unique_ptr<ModelTester> model_tester, std::unique_ptr<GramTester> gram_tester, double gram_weight);
};
